        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            animationDelay: "0.2s"
              ...
              <Button variant="ghost" size="lg" className="text-muted-foreground" asChild>
                <a href="https://scholar.google.com/citations?user=QMh_z-MAAAAJ" target="_blank" rel="noopener noreferrer">
            ...
            {/* Quick Stats */}
            <div className="flex flex-wrap gap-8 pt-6 border-t border-border/50 animate-fade-in-up" style={{
            animationDelay: "0.3s"
          }}>
          ...
          animationDelay: "0.2s"
            ...
            <div className="relative group">
              ...
              <img src={profilePhoto} alt="Hunain Kaisar - AI Researcher" className="relative w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 object-cover rounded-full border-2 border-primary/30 shadow-glow" />
              ...
              <div className="absolute -top-4 -left-4 glass border border-border/50 rounded-xl px-4 py-2 shadow-card animate-float" style={{
              animationDelay: "0.5s"
            }}>
